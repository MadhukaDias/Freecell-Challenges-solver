...
class Card {
 public:
  ...
  // New helper for clean string representation (e.g., "2h", "tc")
  std::string ToCleanString() const {
      char rank_char = "123456789tjqk"[rank()]; // 1-based rank for A=1? No, user said 1:1, 10:t. Wait.
      // User spec: 1:1, 2:2... 9:9, 10:t, J:j, Q:q, K:k.
      // My Rank enum: ACE=0, R2=1...
      // So rank() 0 -> '1', 1 -> '2', ... 8 -> '9', 9 -> 't', 10 -> 'j', 11 -> 'q', 12 -> 'k'
      const char* ranks = "123456789tjqk";
